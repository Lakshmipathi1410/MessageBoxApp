...
{
QMessageBox::information(this,"Laksmipathi","This Is Information Box");
...
{
    QMessageBox::StandardButton reply= QMessageBox::question(this,"Lakshmipathi","this is a custom message",QMessageBox::Yes|QMessageBox::No|QMessageBox::YesAll|QMessageBox::NoAll);
    if(reply==QMessageBox::Yes)
